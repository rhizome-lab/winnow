...
export function hasNext(obj: any, index: number): boolean {
  const keys = Object.keys(obj);
  return index < keys.length;
}

/** AVM2 HasNext2 — advances index, returns whether there are more items. */
export function hasNext2(obj: any, index: number): [any, number, boolean] {
  const keys = Object.keys(obj);
...
export function nextName(obj: any, index: number): string {
  const keys = Object.keys(obj);
