...
export function deleteProperty(obj: any, name: string): boolean {
  try {
...
export function construct(ctor: any, ...args: any[]): any {
  return new ctor(...args);
}

export function newObject(...pairs: any[]): Record<string, any> {
